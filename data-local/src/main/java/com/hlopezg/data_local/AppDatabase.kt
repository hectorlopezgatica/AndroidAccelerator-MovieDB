...
import com.hlopezg.data_local.crossref.MoviesGenresCrossRef
...
@Database(entities = [MovieEntity::class, TvEntity::class, GenreEntity::class, MoviesGenresCrossRef::class], version = 1, exportSchema = false)
